...
#[path = "_61_创建与初始化结构体.rs"]
mod _61_创建与初始化结构体;

#[path = "_62_结构体是移动还是复制.rs"]
mod _62_结构体是移动还是复制;

#[path = "_63_结构体与default_trait.rs"]
mod _63_结构体与default_trait;

#[path = "_64_元组结构体与单元结构体.rs"]
mod _64_元组结构体与单元结构体;

#[path = "_65_编写结构体方法.rs"]
mod _65_编写结构体方法;

#[path = "_66_作为结构体构造函数的关联函数.rs"]
mod _66_作为结构体构造函数的关联函数;

#[path = "_67_结构体的模式匹配.rs"]
mod _67_结构体的模式匹配;

#[path = "_68_ref在结构体模式匹配中的使用.rs"]
mod _68_ref在结构体模式匹配中的使用;

#[path = "_69_在Rust中定义枚举.rs"]
mod _69_在Rust中定义枚举;

#[path = "_70_枚举的方法与关联函数.rs"]
mod _70_枚举的方法与关联函数;

#[path = "_71_使用枚举进行模式匹配.rs"]
mod _71_使用枚举进行模式匹配;

#[path = "_72_option_t_类型.rs"]
mod _72_option_t_类型;

#[path = "_73_option_t_的使用.rs"]
mod _73_option_t_的使用;
...
#[path = "_126_闭包捕获环境.rs"]
mod _126_闭包捕获环境;
#[path = "_127_与闭包相关的Traits.rs"]
mod _127_与闭包相关的Traits;
#[path = "_128_闭包变量的行为.rs"]
mod _128_闭包变量的行为;
#[path = "_129_将闭包作为函数参数传递第1部分.rs"]
...
#[path = "_183_编写声明宏.rs"]
mod _183_编写声明宏;
#[path = "_184_继续编写声明宏.rs"]
mod _184_继续编写声明宏;
#[path = "_185_令牌与令牌树.rs"]
mod _185_令牌与令牌树;
#[path = "_186_编写声明宏的规则.rs"]
mod _186_编写声明宏的规则;
#[path = "_187_继续编写声明宏的规则.rs"]
mod _187_继续编写声明宏的规则;
#[path = "_188_编写重复模式.rs"]
mod _188_编写重复模式;
#[path = "_189_继续编写重复模式.rs"]
mod _189_继续编写重复模式;
#[path = "_190_关于片段限定符.rs"]
mod _190_关于片段限定符;
#[path = "_191_使用不同的片段限定符.rs"]
mod _191_使用不同的片段限定符;
#[path = "_192_生成样板代码.rs"]
mod _192_生成样板代码;
#[path = "_193_生成结构体的getter和setter.rs"]
mod _193_生成结构体的getter和setter;
#[path = "_194_关于宏的卫生性.rs"]
mod _194_关于宏的卫生性;
...
fn main() {
    ...
    if false {
        ...
        _61_创建与初始化结构体::main();
        _62_结构体是移动还是复制::main();
        _63_结构体与default_trait::main();
        _64_元组结构体与单元结构体::main();
        _65_编写结构体方法::main();
        _66_作为结构体构造函数的关联函数::main();
        _67_结构体的模式匹配::main();
        _68_ref在结构体模式匹配中的使用::main();
        _69_在Rust中定义枚举::main();
        _70_枚举的方法与关联函数::main();
        _71_使用枚举进行模式匹配::main();
        ...
        _185_令牌与令牌树::main();
        _186_编写声明宏的规则::main();
        _187_继续编写声明宏的规则::main();
        _188_编写重复模式::main();
        _189_继续编写重复模式::main();
        _190_关于片段限定符::main();
        _192_生成样板代码::main();
        _193_生成结构体的getter和setter::main();
    }
